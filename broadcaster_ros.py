...
def callback_image(data):
    ...
    if rospy.has_param('use_openpose'):
...
if __name__ == '__main__':
    # Check gpu
    parser = argparse.ArgumentParser(description='Check using GPU or not')
    ...
    pub_pose = rospy.Publisher('/pose_estimator/pose', Persons, queue_size=1)
